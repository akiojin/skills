...
```
/github:gh-fix-pr [pr-number|pr-url|optional context]
```

## Steps

1. Load `github/skills/gh-fix-pr/SKILL.md` and follow the workflow.
...
assistant: "gh-fix-pr で PR の状態を診断します。"
</example>

<example>
Context: User mentions PR can't be merged
user: "PRがマージできない"
assistant: "gh-fix-pr で blocking items を診断します。"
</example>

## Examples

```
/github:gh-fix-pr 123
```

```
/github:gh-fix-pr https://github.com/org/repo/pull/123
```
